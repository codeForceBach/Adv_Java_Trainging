...
public class Guest {
    ...
    /*
    //need to modify for java 8 that doesn't support List.of(varag...) to add each room to the list of preferredRooms
    public void setPreferredRooms(List<Room> preferredRooms) {
        this.preferredRooms = preferredRooms;
    }
     */

    public void setPreferredRooms(Room preferRoom){
        preferredRooms.add(preferRoom);
    }
